...
/** Extension config used to build a BlobServiceClient. @category Azure */
...
/** Resolved credentials for SAS signing (account key required for user-delegation-free SAS). @category Azure */
